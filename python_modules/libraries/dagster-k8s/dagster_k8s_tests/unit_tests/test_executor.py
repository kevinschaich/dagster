...
bar_with_resources = make_bar_with_resources()


def make_bar_with_images():
...
bar_with_images = make_bar_with_images()
...
def test_requires_k8s_launcher_fail():
    with instance_for_test() as instance:
        with pytest.raises(
            ...
            execute_job(reconstructable(bar), instance=instance)
