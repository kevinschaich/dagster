...
```python file=/integrations/snowflake/pyspark.py startafter=start_configuration endbefore=end_configuration
ENOENT: no such file or directory, open '/Users/jamie/dev/dagster/examples/docs_snippets/docs_snippets/integrations/snowflake/pyspark.py'
```
