...
## Step 4: Set up a GitHub action to cache your dbt Cloud job's compilation

<Note>This step is optional.</Note>

In Step 2, your dbt project is compiled when your Dagster definitions are first loaded. Because of this compilation step, you may encounter high latency when you load your code locations as you wait for the compilation to complete. Instead of compiling at runtime, a cached compilation can be used. A reference to this cached compilation can be created by using a GitHub action on your dbt Cloud project.

You'll need the following secrets in your GitHub repository:
...
Then, add a GitHub action that will cache the compilation of your dbt project. This action can be triggered on a push to your main branch.
